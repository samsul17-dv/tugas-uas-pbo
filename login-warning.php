...
<head>
    ...
    <link rel="stylesheet" href="assets/css/login-warning.css">
</head>
...
<body>
    ...
    <div class="login-container-mobile">
        ...
        <img src="assets/images/icon/9.png" class="login-images">
    ...
    <div class="login-container-desktop">
        <div class="login-card">
            ...
            <h5 class="version" style="font-weight: 300; font-family: 'Poppins', sans-serif; color: #5E17EB;">
                Don't have an account? <a href="regist.html" style="color: #5E17EB;">Create Now</a>
            </h5>
        </div>
    </div>
